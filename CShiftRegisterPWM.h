/*
CShiftRegisterPWM.h - Library for Arduino to PWM many outputs using shift registers
...
#ifndef CShiftRegisterPWM_h
#define CShiftRegisterPWM_h

#include <Arduino.h>

class CShiftRegisterPWM{
public:
	CShiftRegisterPWM(int timerInUse, bool noSPI, int latchPin, int dataPin, int clockPin);
	~CShiftRegisterPWM();

public:
	void Start(float ledFrequency, unsigned char max_Brightness);
    void PFCUpdate(float ledFrequency);
